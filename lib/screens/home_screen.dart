...
import 'package:passvault/db/password_database.dart';
import 'package:passvault/model/password_model.dart';
import 'package:passvault/screens/add_task_screen.dart';
import 'package:passvault/screens/password_generator_screen.dart';
import 'package:passvault/screens/password_viewer_screen.dart';
import 'package:passvault/screens/settings_screen.dart';
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        child: Container(
          ...
          decoration:
              BoxDecoration(shape: BoxShape.circle, color: Color(0xff0F4DF3)),
        ),
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            backgroundColor: Color(0xff151922),
            title:
                Text('Password Vault', style: TextStyle(color: Colors.white)),
            actions: [
              IconButton(
